...
\`\`\`
Output: { pnl_pct, pnl_sol, unclaimed_fee_usd, all_time_fees_usd, current_value_usd, lower_bin, upper_bin, active_bin }
\`\`\`
...
\`\`\`
Output: { success, pnl_pct, pnl_sol, txs, base_mint }
\`\`\`

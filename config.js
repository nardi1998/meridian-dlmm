...
export const config = {
  ...
  screening: {
    ...
    maxPoolTokenAgeDeltaHours: u.maxPoolTokenAgeDeltaHours !== undefined ? u.maxPoolTokenAgeDeltaHours : 720, // null = no limit
  ...
  management: {
    ...
    whaleEscapeEnabled: u.whaleEscapeEnabled ?? true,
    whaleEscapeApi: u.whaleEscapeApi ?? "datapi",
    whaleEscapeWarnTvlPct: u.whaleEscapeWarnTvlPct ?? 8,
    whaleEscapeCloseTvlPct: u.whaleEscapeCloseTvlPct ?? 15,
    whaleEscapeAbsFloorUsd: u.whaleEscapeAbsFloorUsd ?? 10000,
    whaleEscapeLegacyAbsFloorUsd: u.whaleEscapeLegacyAbsFloorUsd ?? 5000,
    whaleEscapeBottomBinDistance: u.whaleEscapeBottomBinDistance ?? 3,
    whaleEscapeNetDepCacheSec: u.whaleEscapeNetDepCacheSec ?? 30,
    ...
    // SOL mode — positions, PnL, and balances reported in SOL (canonical unit)
  ...
  schedule: {
    ...
    whaleActivityIntervalMin:  u.whaleActivityIntervalMin ?? 5,

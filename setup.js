...
const FIELD_SECTIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "maxPoolTokenAgeDeltaHours", label: "Max pool/token age difference hours (or null)", type: "number", min: 0, nullable: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "whaleEscapeCloseTvlPct", label: "Whale escape close TVL % threshold", type: "number", min: 0 },
      { key: "whaleEscapeAbsFloorUsd", label: "Whale escape absolute USD floor", type: "number", min: 0 },
      { key: "whaleEscapeLegacyAbsFloorUsd", label: "Whale escape legacy USD floor", type: "number", min: 0 },
      { key: "whaleEscapeBottomBinDistance", label: "Whale escape bottom-bin distance", type: "number", min: 0 },
      { key: "whaleEscapeNetDepCacheSec", label: "Whale escape net dep cache (seconds)", type: "number", min: 1 },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "whaleActivityIntervalMin", label: "Whale escape check interval (minutes)", type: "number", min: 1 },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "screeningThinkingEnabled", label: "Screening thinking mode? (true/false, MiMo only)", type: "boolean" },
      { key: "managementThinkingEnabled", label: "Management thinking mode? (true/false, MiMo only)", type: "boolean" },
      { key: "generalThinkingEnabled", label: "General thinking mode? (true/false, MiMo only)", type: "boolean" },

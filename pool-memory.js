...
export function recordPoolDeploy(poolAddress, deployData) {
  ...
  const deploy = {
    ...
    pnl_sol: deployData.pnl_sol ?? deployData.pnl_usd ?? null,
    fees_earned_sol: deployData.fees_earned_sol ?? deployData.fees_earned_usd ?? null,
...
export function recordPositionSnapshot(poolAddress, snapshot) {
  ...
  db[poolAddress].snapshots.push({
    ...
    pnl_sol: snapshot.pnl_sol ?? snapshot.pnl_usd ?? null,

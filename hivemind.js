    ...
    return await requestJson("/api/hivemind/performance/push", {
      ...
      body: {
        ...
        event: {
          ...
          pnlUsd: Number(perf.pnl_sol ?? perf.pnl_usd ?? 0),
          pnlSol: Number(perf.pnl_sol ?? perf.pnl_usd ?? 0),
          pnlPct: Number(perf.pnl_pct || 0),
          feesUsd: Number(perf.fees_earned_sol ?? perf.fees_earned_usd ?? 0),
          feesSol: Number(perf.fees_earned_sol ?? perf.fees_earned_usd ?? 0),
